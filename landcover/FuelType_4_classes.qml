...
<qgis maxScale="0" minScale="1e+08" version="3.16.15-Hannover" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="1" alphaBand="-1" type="singlebandpseudocolor" nodataColor="" classificationMin="0" band="1" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="0" colorRampType="DISCRETE" classificationMode="2" clip="0" labelPrecision="0" maximumValue="1">
          ...
          <item alpha="255" color="#0bd1f8" value="1" label="Croplands/Grasslands"/>
          <item alpha="255" color="#f3db02" value="2" label="Low flammable forests"/>
          <item alpha="255" color="#dc1721" value="3" label="Shrublands"/>
          <item alpha="255" color="#ff00ff" value="4" label="High flammable forests"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
