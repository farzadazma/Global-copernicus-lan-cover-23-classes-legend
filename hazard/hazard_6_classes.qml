...
<qgis styleCategories="AllStyleCategories" maxScale="0" version="3.16.15-Hannover" hasScaleBasedVisibilityFlag="0" minScale="1e+08">
  <flags>
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" band="1" classificationMax="1" classificationMin="0" type="singlebandpseudocolor" alphaBand="-1" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader classificationMode="2" minimumValue="0" maximumValue="1" colorRampType="DISCRETE" clip="0" labelPrecision="0">
          ...
          <item label="Very low" color="#0bd1f8" value="1" alpha="255"/>
          <item label="Low" color="#1ff238" value="2" alpha="255"/>
          <item label="Medium" color="#f3db02" value="3" alpha="255"/>
          <item label="Medium-high" color="#ea8d1b" value="4" alpha="255"/>
          <item label="High" color="#dc1721" value="5" alpha="255"/>
          <item label="Extreme" color="#ff00ff" value="6" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
    <brightnesscontrast contrast="0" gamma="1" brightness="0"/>
    <huesaturation colorizeOn="0" colorizeGreen="128" colorizeBlue="128" colorizeRed="255" saturation="0" grayscaleMode="0" colorizeStrength="100"/>
